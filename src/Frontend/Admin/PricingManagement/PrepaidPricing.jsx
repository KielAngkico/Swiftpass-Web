    ...
    <div className="min-h-screen flex">
      <div className="flex-1 p-2">
        <div className="mb-2">
          ...
          <p className="text-[10px] text-gray-500">Manage prepaid plans and payment methods</p>
        </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              <div>
                ...
                <div className="text-[9px] opacity-90">Add a new prepaid plan</div>
              </div>
            </button>
            ...
            {showForm && (
              <div className="bg-white rounded shadow p-2 relative text-xs">
                ...
                <div className="space-y-1">
                  <input
                    type="text"
                    placeholder="Plan Name (e.g., Top-up ₱100)"
              ...
              {plans.map((plan) => (
                <div key={plan.id} className="bg-white rounded shadow hover:shadow-md p-2 text-xs">
                  ...
                  <div className="flex justify-between mb-1 text-[10px]">
                    ...
                    <div className="text-center">
                      <p className="text-gray-600">Gets</p>
                      <p className="font-bold text-blue-600">₱{parseFloat(plan.amount_to_credit).toFixed(2)}</p>
                    </div>
                  </div>
                  <div className="bg-blue-50 text-blue-700 px-1 py-0.5 rounded-full text-center text-[9px] mb-2">
