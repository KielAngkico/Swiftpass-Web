      ...
      <main className="flex-1 min-w-0 p-6">
        ...
        <div className="flex items-center gap-2 mb-5">
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg px-3 py-1.5 text-xs text-gray-900 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
            <div className="bg-white border border-gray-200 rounded-xl shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
              <div className="p-5 border-b border-gray-100 flex justify-between items-center">
                <div>
                  <p className="text-sm font-medium text-gray-900">Create New Order</p>
                  <p className="text-xs text-gray-500 mt-0.5">Select items from available inventory</p>
                </div>
                <button
              ...
              <div className="p-5 space-y-5">
                <div>
                  <p className="text-xs font-medium text-gray-900 mb-3 pb-2 border-b border-gray-100">Available Inventory</p>
                      ...
                      availableInventory.map((item) => (
                        <div key={item.id} className="flex justify-between items-center p-3 bg-white border border-gray-200 rounded-xl">
                          ...
                          <button
                            ...
                            className="bg-white text-blue-600 border border-blue-200 hover:bg-blue-50 px-3 py-1.5 rounded-lg text-[13px] font-medium transition-colors disabled:border-gray-200 disabled:text-gray-400 disabled:hover:bg-white flex-shrink-0 ml-2"
                          >
                      ...
                      {selectedItems.map((item) => (
                        <div key={item.item_name} className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-xl">
                          ...
                          <input
                            ...
                            className="w-14 border border-gray-200 rounded-lg px-2 py-1.5 text-xs text-gray-900 text-center focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                          />
                          ...
                          <button
                            ...
                            className="bg-white text-red-500 border border-red-100 hover:bg-red-50 px-2.5 py-1 rounded-lg text-[13px] font-medium transition-colors flex-shrink-0"
                          >
                            Remove
                          </button>
                        </div>
