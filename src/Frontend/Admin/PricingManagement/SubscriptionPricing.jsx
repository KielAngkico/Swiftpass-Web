  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        console.log("📥 SubscriptionPricing user:", data);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 w-full">
      <div className="w-full">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Subscription Pricing</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          >
            ...
            <div className="text-left">
              <div className="font-semibold">Add New Plan</div>
              <div className="text-sm opacity-90">Create subscription plan</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-sm opacity-90">Configure payments</div>
            </div>
          </button>
        </div>
      {showForm && (
      ...
      <div className="mb-8">
        ...
        {plans.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-8 text-center text-gray-500">
            No subscription plans available. Create your first plan above.
          </div>
        ) : (
              ...
              <div key={plan.id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-4 group">
                ...
                <div className="mb-3">
                  ...
                  <div className="text-gray-600 text-sm">
                    for {plan.duration_in_days} day{plan.duration_in_days > 1 ? "s" : ""}
                  </div>
                </div>
                
                <div className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-center text-sm font-medium">
                  {plan.duration_in_days} day{plan.duration_in_days > 1 ? "s" : ""} access
                </div>
              </div>
            ))}
          </div>
