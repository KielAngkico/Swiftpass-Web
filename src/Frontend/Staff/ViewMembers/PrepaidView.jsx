            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-shrink-0">
                <img
                  ...
                  className="w-40 h-40 object-cover border-4 border-indigo-500 shadow-md rounded-full"
                />
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-700">
                  ...
                  <p>
                    ...
                    <span className="inline-block ml-2 px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-700">
                      ₱{parseFloat(selectedMember.current_balance || 0).toFixed(2)}
                    </span>
                  </p>
                  <p>
