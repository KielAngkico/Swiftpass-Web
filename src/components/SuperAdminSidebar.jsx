...
import { FiClipboard , FiMenu, FiUsers, FiShoppingCart, FiDollarSign, FiPackage, FiBarChart2 } from "react-icons/fi";
...
const SuperAdminSidebar = () => {
  ...
  const navItems = useMemo(() => {
    ...
    return [
      ...
      { path: "/SuperAdmin/AuditTrails", label: "Audit Trails",    icon: <FiClipboard /> },
    ];
  }, [user]);
