  ...
  useEffect(() => {
    const fetchAdminInfo = async () => {
      try {
        ...
        if (data.user.role !== "admin") throw new Error("Only admins can access this page");
...
export default AdminViewDayPass;